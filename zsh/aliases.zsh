...
alias -g mv="mv -i"
alias -g cp="cp -ir"
alias -g l="eza -la --color=always --color-scale=size --color-scale-mode=fixed --icons=always --hyperlink --group-directories-first --smart-group -o --no-permissions --git"
alias -g ls="eza -a1 --color=always --icons=always --hyperlink --group-directories-first"
alias -g lsg="eza -la --color=always --color-scale=size --color-scale-mode=fixed --icons=always --hyperlink --group-directories-first --smart-group -o --no-permissions --git --git-ignore"
alias -g lt="eza -la --color=always --color-scale=size --color-scale-mode=fixed --icons=always --hyperlink --group-directories-first --smart-group -o --no-permissions --git -T"
